...
vr::EVRInitError DeviceProvider::Init( vr::IVRDriverContext *pDriverContext )
{
	...
	{
		vr::VRDriverLog()->Log( "Failed to create left controller device!" );
	...
	{
		vr::VRDriverLog()->Log( "Failed to create right controller device!" );
		// We failed? Return early.
		return vr::VRInitError_Driver_Unknown;
	}
...
void DeviceProvider::RunFrame()
{
	...
	if ( my_left_controller_device_ != nullptr && my_right_controller_device_ != nullptr )
	{
